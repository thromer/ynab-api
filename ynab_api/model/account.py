...
class Account(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'last_reconciled_at': (datetime,),  # noqa: E501
            'debt_original_balance': (int,),  # noqa: E501
    ...
    def _from_openapi_data(cls, id, name, type, on_budget, closed, balance, cleared_balance, uncleared_balance, transfer_payee_id, deleted, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            last_reconciled_at (datetime): A date/time specifying when the account was last reconciled.. [optional]  # noqa: E501
            debt_original_balance (int): The original debt/loan account balance, specified in milliunits format.. [optional]  # noqa: E501
